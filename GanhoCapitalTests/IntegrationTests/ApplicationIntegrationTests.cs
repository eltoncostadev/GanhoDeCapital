...
namespace CapitalGains.Tests.IntegrationTests
{
    public class ApplicationIntegrationTests
    {
        ...
        {
            // Arrange - Caso #4 da especificação
            var input = "[{\"operation\":\"buy\", \"unit-cost\":10.00, \"quantity\": 10000}," +
        ...
        {
            // Arrange - Caso #5 da especificação
            var input = "[{\"operation\":\"buy\", \"unit-cost\":10.00, \"quantity\": 10000}," +
                        "{\"operation\":\"buy\", \"unit-cost\":25.00, \"quantity\": 5000}," +
                        "{\"operation\":\"sell\", \"unit-cost\":15.00, \"quantity\": 10000}," +
        ...
        {
            // Arrange - Caso #6 da especificação
            var input = "[{\"operation\":\"buy\", \"unit-cost\":10.00, \"quantity\": 10000}," +
        ...
        {
            // Arrange - Caso #7 da especificação
            var input = "[{\"operation\":\"buy\", \"unit-cost\":10.00, \"quantity\": 10000}," +
                        "{\"operation\":\"sell\", \"unit-cost\":2.00, \"quantity\": 5000}," +
                        "{\"operation\":\"sell\", \"unit-cost\":20.00, \"quantity\": 2000}," +
                        "{\"operation\":\"sell\", \"unit-cost\":20.00, \"quantity\": 2000}," +
        ...
        {
            // Arrange - Caso #8 da especificação
            var input = "[{\"operation\":\"buy\", \"unit-cost\":10.00, \"quantity\": 10000}," +
        ...
        {
            // Arrange - Caso #9 da especificação
